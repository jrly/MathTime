...
public class subActivity extends Activity {
    ...
    public void generateQuestion() {
        ...
        //ensure that negative numbers don't crash the app
        while (a <= b){
            b = rand.nextInt(21);
        }
        ...
        for (int i=0; i<4;i++){
            ...
            if(i == locationOfCorrectAnswer){
                ...
                incorrectAnswer = rand.nextInt((a - b));      //caused error, passses a negative when a < b
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sub = (TextView) findViewById(R.id.divTextView);
